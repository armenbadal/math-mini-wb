...
\centerline{տեքստային խնդիրներ}
\centerline{հայերեն, անգլերեն եւ ռուսերեն}
\vfil
\centerline{2025}
\eject
\line{}\vfil\eject
...
\textproblem Ավտոմեքենան 3 ժամում անցավ 240 կմ ճանապարհ:
Քանի՞ ժամում կանցնի այդ ճանապարհը բեռնատարը, եթե դրա
արագությունն ավտոմեքենայի արագությունից 20 կմ/ժ պակաս է:\answer{?}

\textproblem Հեծանվորդը 2 ժամում անցավ 54 կմ։ Նույն ճանապարհը
1 ձիավորն անցավ 6 ժամում: Որքա՞ն է նրանց արագությունների
տարբերությունը։\answer{?}

\textproblem Հայրիկը գնեց 14 հատ պաղպաղակ եւ վճարեց 260
դրամով ավելի, քան մայրիկը՝ նույնպիսի 10 պաղպաղակի համար։
Որքա՞ն պետք է վճարել եւս 8 պաղպաղակ գնելու համար։\answer{?}

\textproblem Գնացքը 4 ժամ սլանում է 300 կմ/ժ արագությամբ։
Հետո եւս երկու ժամ գնաց 50 կմ/ժ պակաս արագությամբ: Որքա՞ն
ճանապարհ անցավ գնացքն այդ 6 ժամում:\answer{?}
...
\textproblem Serena had 35 cherries. She gave 8 to each of
her sisters. She still has 3 left over. How many sisters
does Serena have?\answer{?}

\textproblem За 3 мин самолёт пролетел 30 км. Какое расстояние
пролетит он за 40 мин, если его скорость увеличится на 5 км/мин?\answer{?}

\textproblem В мешке было 45 кг моркови. Три дня из мешка
брали моркови поровну, после чего в нём осталось 33 кг.
Сколько кг моркови брали из мешка каждый день?\answer{?}
...
\textproblem The school office printer can print 200 pages
every 10 minutes. If the printer runs for an hour straight,
how many pages can it print?\answer{?}
